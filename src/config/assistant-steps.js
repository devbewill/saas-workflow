...
export const ASSISTANT_STEPS = {
    ...
    preliminary_check: {
        ...
        warning: { type: 'info', title: 'NOTA', message: 'Verifica che il codice fiscale del condominio sia corretto prima di procedere.' },
    ...
    document_validation: {
        ...
        warning: { type: 'info', title: 'PROMEMORIA', message: 'Ricorda che il documento di identità deve essere in corso di validità.' },
    ...
    aml_check: {
        ...
        warning: { type: 'warning', title: 'ATTENZIONE', message: 'In caso di esito "Arancione - Forzante" è necessaria una verifica rafforzata prima di procedere.' },
    ...
    credit_check: {
        ...
        warning: { type: 'info', title: 'NOTA', message: 'Verifica la presenza di garanzie MCC se applicabili.' },
    ...
    post_works: {
        ...
        warning: { type: 'warning', title: 'IMPORTANTE', message: 'Verificare che i lavori siano conformi al capitolato approvato.' },
    ...
    liquidation: {
        ...
        warning: { type: 'warning', title: 'ATTENZIONE', message: "Verificare che l'IBAN corrisponda a quello indicato nella delibera." },
