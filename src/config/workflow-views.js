...
export const WORKFLOW_VIEW_CONFIG = {
    'Bozza': {
        availableTabs: ['info', 'documenti', 'pagamenti', 'fascicoli', 'team', 'scoring'],
        defaultTab: 'info',
        showAssistant: true,
    ...
    'Caricata - Lavorazione AML e Banche Dati': {
        availableTabs: ['aml', 'documenti', 'fascicoli', 'info', 'team', 'scoring'],
        defaultTab: 'aml',
        showAssistant: true,
    ...
    'Approvata – Valutazione post fine lavori': {
        availableTabs: ['lavori', 'documenti', 'finanziario', 'scoring'],
        defaultTab: 'lavori',
        showAssistant: true,
    ...
    'Approvata – Pronta per stampa contratto': {
        availableTabs: ['contratto', 'documenti', 'info', 'scoring'],
    ...
    'Approvata – Contratto firmato': {
        availableTabs: ['contratto', 'documenti', 'finanziario', 'scoring'],
        defaultTab: 'contratto',
        showAssistant: true,
    ...
    'Perfezionata – Da liquidare': {
        availableTabs: ['finanziario', 'documenti', 'info', 'scoring'],
    ...
    'Validazione Doc Preliminari': {
        availableTabs: ['documenti', 'info', 'fascicoli', 'team', 'scoring'],
        defaultTab: 'documenti',
        showAssistant: true,
        assistantConfigKey: 'document_validation',
    ...
    'Attesa Antiriciclaggio': {
        availableTabs: ['aml', 'documenti', 'info', 'team', 'scoring'],
        defaultTab: 'aml',
        showAssistant: true,
        assistantConfigKey: 'aml_check',
    ...
    'In attesa valutazione': {
        availableTabs: ['info', 'documenti', 'fascicoli', 'team', 'scoring'],
        defaultTab: 'info',
        showAssistant: true,
        assistantConfigKey: 'evaluation',
    ...
    'Presentazione in Banca': {
        availableTabs: ['info', 'documenti', 'team', 'scoring'],
        defaultTab: 'info',
        showAssistant: true,
    ...
    'Finanziamento Approvato': {
        availableTabs: ['delibera', 'documenti', 'info', 'scoring'],
        defaultTab: 'delibera',
        showAssistant: true,
        assistantConfigKey: null,
    ...
    'Finanziamento Erogato': {
        availableTabs: ['info', 'documenti', 'finanziario', 'storico', 'scoring'],
        defaultTab: 'finanziario',
        showAssistant: false,
        assistantConfigKey: null,
        isFinal: true,
...
const DEFAULT_VIEW_CONFIG = {
    availableTabs: ['info', 'documenti', 'pagamenti', 'team', 'scoring'],
    defaultTab: 'info',
    showAssistant: false,
    assistantConfigKey: null,
    primaryAction: null,
