 ...
 * Defines what each role can see and which specific components should be rendered.
 */
...
// Default user identity for simulation
export const MOCK_USER = {
    id: 'user-123',
    name: 'Stefano Perelli',
    email: 'stefano.perelli@blueprint.it',
    initials: 'SP',
    role: ROLES.GESTORE // Default simulation role
};
