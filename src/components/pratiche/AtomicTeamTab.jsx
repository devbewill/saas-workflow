...
import { UserPlus, Mail, Shield, ShieldCheck, Copy, Check } from 'lucide-react';
    ...
    <div className="grid gap-6">
       <div className="flex flex-col gap-2">
            ...
            <p className="text-muted-foreground">
                Assegna i ruoli necessari per la gestione della pratica. Il supervisore è obbligatorio.
            </p>
       </div>
