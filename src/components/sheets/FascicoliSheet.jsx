                ...
                <div className="flex-1 overflow-y-auto">
                    ...
                    <div className="space-y-6 p-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="border border-border/60 rounded-xl h-[400px] overflow-y-auto p-4 space-y-2 bg-slate-50/30">
                                {DOCUMENTS.map(doc => (
                                    <div key={doc.id} className="flex items-start space-x-3 p-2 hover:bg-white hover:shadow-sm rounded-lg transition-all border border-transparent hover:border-border/40">
                                        <input
                                            type="checkbox"
                                            className="mt-1 h-4 w-4 shrink-0 rounded-sm border border-primary ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 cursor-pointer"
                        ...
                        <div className="flex items-center space-x-2 bg-slate-50 rounded-xl p-4 border border-border/40">
                            <input
                                type="checkbox"
                                id="sig-check"
