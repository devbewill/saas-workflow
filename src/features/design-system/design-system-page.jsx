...
export default function DesignSystemPage() {
  ...
  const [demoNotes, setDemoNotes] = useState([
    {
      id: 1,
      text: "Verifica completata senza segnalazioni.",
      author: "Marco Bianchi",
      date: "08/02/2026 14:30",
      isPublic: true,
    },
    {
      id: 2,
      text: "Nota interna per il team legale.",
      author: "Laura Rossi",
      date: "07/02/2026 10:15",
      isPublic: false,
    },
  ]);
  ...
  return (
    <>
      <PageHeader
        title="Design System"
        subtitle="Catalogo completo dei componenti UI della piattaforma"
      />
      ...
      <Tabs defaultValue="primitivi" className="space-y-6">
        ...
        <TabsContent value="primitivi" className="space-y-8">
          ...
          <SectionPanel
            title="Button"
            description="Pulsanti per azioni e interazioni"
          >
          ...
          <SectionPanel
            title="Badge"
            description="Indicatori di stato e categorizzazione"
          >
            <div className="flex flex-wrap gap-3">
              <Badge>Default</Badge>
          ...
          <SectionPanel
            title="Card"
            description="Contenitore principale per raggruppare informazioni"
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Descrizione opzionale della card.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Contenuto della card con qualsiasi tipo di contenuto.
                  </p>
                </CardContent>
                <CardFooter>
              ...
              <Card>
                <CardContent className="pt-6">
                  <p className="text-sm">
                    Card senza header — utilizzabile per contenuti semplici.
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <SectionPanel
            ...
            description="Campi di testo per form e filtri"
          >
          ...
          <SectionPanel
            title="Select"
            description="Menu a tendina per selezioni"
          >
          ...
          <SectionPanel
            ...
            description="Elementi per selezioni booleane"
          >
            <div className="space-y-4">
          ...
          <SectionPanel
            title="Avatar"
            description="Visualizzazione utente con iniziali"
          >
            <div className="flex gap-4 items-center">
              ...
              <Avatar className="h-12 w-12">
                <AvatarFallback className="text-lg">SP</AvatarFallback>
              </Avatar>
            </div>
          </SectionPanel>
          ...
          <SectionPanel
            title="Table"
            description="Tabelle dati con header, body and row styling"
          >
            <Table>
              <TableHeader>
                <TableRow>
              ...
              <TableBody>
                <TableRow>
                  ...
                  <TableCell>Progetto Alpha</TableCell>
                  <TableCell>
                    <Badge>Attivo</Badge>
                  </TableCell>
                ...
                <TableRow>
                  ...
                  <TableCell>Progetto Beta</TableCell>
                  <TableCell>
          ...
          <SectionPanel title="Accordion" description="Sezioni espandibili">
            <Accordion type="single" collapsible>
              <AccordionItem value="item-1">
                ...
                <AccordionContent>
                  L'accordion permette di nascondere e mostrare contenuti senza
                  occupare spazio.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-2">
                ...
                <AccordionContent>
                  Sì, puoi utilizzare qualsiasi contenuto all'interno
                  dell'accordion.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          ...
          <SectionPanel
            title="Sheet"
            description="Pannello laterale per azioni contestuali"
          >
            <div className="flex gap-3">
              <Sheet>
                <SheetTrigger asChild>
                  <Button variant="outline">Apri Sheet (Destra)</Button>
                </SheetTrigger>
                <SheetContent>
                  <SheetHeader>
              ...
              <Sheet>
                <SheetTrigger asChild>
                  <Button variant="outline">Apri Sheet (Sinistra)</Button>
                </SheetTrigger>
          ...
          <SectionPanel
            title="Dropdown Menu"
            description="Menu contestuale per azioni"
          >
            <DropdownMenu>
          ...
          <SectionPanel
            title="Tooltip"
            description="Informazioni al passaggio del mouse"
          >
        ...
        <TabsContent value="composti" className="space-y-8">
          ...
          <SectionPanel
            title="InfoGrid"
            description="Griglia label:valore per dati strutturati"
          >
            <InfoGrid
              items={[
          ...
          <SectionPanel
            title="StatusBadge"
            description="Badge semantico per stati del dominio"
          >
            <div className="flex flex-wrap gap-3">
          ...
          <SectionPanel
            title="SearchInput"
            description="Input con icona di ricerca"
          >
            <SearchInput
          ...
          <SectionPanel
            title="PageHeader"
            description="Intestazione pagina con status e owner inline"
          >
          ...
          <SectionPanel
            title="UserAvatar"
            description="Avatar con nome ed email"
          >
            <div className="flex flex-col gap-4">
              <UserAvatar
                name="Stefano Perelli"
                email="stefano@blueprint.it"
                size="sm"
              />
          ...
          <SectionPanel
            title="FileUpload"
            description="Area di caricamento file"
          >
          ...
          <SectionPanel
            title="Checklist"
            description="Lista interattiva con checkbox"
          >
            <Checklist
          ...
          <SectionPanel
            title="EmptyState"
            description="Placeholder per aree vuote"
          >
            <EmptyState
              icon={Inbox}
          ...
          >
            <p className="text-sm text-muted-foreground">
              SectionPanel è il wrapper più usato nell'app per raggruppare
              contenuti con titolo, icona e azioni.
            </p>
          </SectionPanel>
        </TabsContent>
        ...
        <TabsContent value="patterns" className="space-y-8">
          ...
          <SectionPanel
            ...
            icon={Loader2}
            description="Rappresentazione verticale degli step con stati completato/corrente/futuro, linea di connessione e badge"
          >
          ...
          <SectionPanel
            ...
            icon={ShieldAlert}
            description="Cerchio colorato dinamico usato nella verifica AML e Banche Dati"
          >
              ...
              <div className="flex gap-6">
                {[
                  ...
                  >
                    <div
                      className={cn(
                        "w-10 h-10 rounded-full flex items-center justify-center text-white text-sm font-semibold shadow",
                        cfg.color,
                      )}
                    >
                      {cfg.icon}
                    ...
                    <span
                      className={cn("text-[10px] font-bold", cfg.textColor)}
                    >
                      {cfg.label}
                    </span>
                  </div>
          ...
          {/* Forzante Warning */}
          <SectionPanel
            title="Componente Forzante"
            icon={AlertTriangle}
            description="Warning alert + upload aggiuntivo visibile quando l'esito AML è 'Arancione — Forzante'"
          >
            <div className="max-w-lg space-y-3">
              <div className="rounded-lg bg-yellow-50 border border-yellow-200 p-4 text-sm text-yellow-800">
                ...
                <p>
                  In caso di esito "Arancione — Forzante" è necessaria una
                  verifica rafforzata con documentazione aggiuntiva
                  obbligatoria.
                </p>
              </div>
              <FileUpload
                label="Carica documentazione rafforzata"
                accept=".pdf,.doc,.docx"
              />
          ...
          {/* Note di Processo */}
          <SectionPanel
            title="Note di Processo"
            icon={MessageSquare}
            description="Sezione note con switch pubblica/privata — ogni processo (AML, Banche Dati) ha le proprie note indipendenti"
          >
            <div className="max-w-lg space-y-3">
          ...
          <SectionPanel
            ...
            icon={FileText}
            description="Pattern tabellare documenti con indicatore upload, CTA note per tutti i documenti, e visibilità nota"
          >
            <Table>
              <TableHeader>
                <TableRow>
          ...
          <SectionPanel
            title="Condomino Dots"
            icon={Users}
            description="Pattern compatto per visualizzare lo stato di multipli wallet (es. condomini) in una tabella, con espansione all'hover"
          >
            <div className="flex items-center gap-8 p-4 border rounded-lg">
              ...
              <div className="text-xs text-muted-foreground max-w-[200px]">
                <p>
                  Utilizzato nella vista <strong>Gestore</strong> per mostrare a
                  colpo d'occhio lo stato di attivazione di tutti i condomini di
                  un progetto.
                </p>
              </div>
            </div>
          ...
          <SectionPanel
            title="Terminal Card"
            icon={Terminal}
            description="Card stile terminale dark per log di sistema e attività live (usato nella vista Tech)"
          >
            <Card className="bg-slate-900 border-none shadow-xl text-white overflow-hidden p-5 relative min-h-[180px] max-w-md">
              <Terminal
                className="absolute bottom-[-10px] right-[-10px] opacity-10"
                size={100}
              />
