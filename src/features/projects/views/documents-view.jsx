  ...
  const [notes, setNotes] = useState(
    doc.notesCount > 0
      ? [
          {
            id: 1,
            text: "Documento verificato e conforme.",
    ...
    <Sheet>
      ...
      <SheetContent>
        <SheetHeader>
          ...
          <SheetDescription>
            Aggiungi o consulta le note relative al documento
          </SheetDescription>
        </SheetHeader>
          ...
          <div className="space-y-3 max-h-[400px] overflow-y-auto">
            {notes.length === 0 ? (
              <p className="text-xs text-muted-foreground text-center py-6">
                Nessuna nota presente. Aggiungi la prima nota.
              </p>
            ) : (
              notes.map((note) => (
  ...
  return (
    <div className="space-y-4 pt-4">
      ...
      <SectionPanel
        ...
        icon={FileText}
        description={`Categoria: ${filterCategory || "Tutte"}`}
      >
        <Table>
          <TableHeader>
            <TableRow>
