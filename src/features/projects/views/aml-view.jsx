...
const getRiskConfig = (outcome) => {
  ...
  if (outcome.startsWith("arancione"))
    return {
      color: "bg-orange-500",
...
// --- Main Component ---
export default function AmlView({ activeApp }) {
  ...
  const [amlNotes, setAmlNotes] = useState([
    {
      id: 1,
      text: "Richiesta adeguata verifica rafforzata inviata via mail.",
  ...
  const [dbNotes, setDbNotes] = useState([
    {
      id: 2,
      text: "Controllo CRIF effettuato con successo. Nessuna segnalazione rilevante.",
      author: "Laura Rossi",
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            ...
            {isForzante && (
              <div className="space-y-3 animate-in slide-in-from-top-2">
                ...
                />
                <Textarea
                  placeholder="Motivazione della forzatura..."
                  rows={3}
                />
              </div>
            )}
            ...
            <Button disabled={!amlOutcome} className="w-full">
              Conferma Esito AML
            </Button>
        ...
        <SectionPanel title="Controllo Banche Dati" icon={Database}>
          <div className="space-y-4">
            ...
            {/* BD file upload */}
            <FileUpload
              label="Carica esito Banche Dati"
              accept=".pdf,.doc,.docx"
            />

            <Button disabled={!dbOutcome} className="w-full">
              Conferma Esito BD
            </Button>
